...
class SpiderDom
{
    ...
    public static function getGreater(\DOMElement $a, \DOMElement $b = null, $options = [])
    {
        if (!$b) {
            return $a;
        }
    ...
    {
        foreach (['iframe', 'script', 'style', 'noscript'] as $tag) {
